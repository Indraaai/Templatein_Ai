                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <div class="flex flex-col items-center">
                                <div
                                    class="w-32 h-32 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white text-4xl font-bold">
                                    {{ strtoupper(substr($student->name, 0, 2)) }}
                                </div>
                                <h3 class="mt-4 text-xl font-semibold text-gray-900 dark:text-white text-center">
                                    {{ $student->name }}
                                </h3>
                            ...
                            <div class="mt-6 space-y-4">
                                <div class="border-t border-gray-200 dark:border-gray-700 pt-4">
                                    <div class="flex items-center text-sm">
                                        ...
                                        <div class="flex-1">
                                            <div class="text-gray-500 dark:text-gray-400">Terdaftar</div>
                                ...
                                <div class="border-t border-gray-200 dark:border-gray-700 pt-4">
                                    <div class="flex items-center text-sm">
                                        ...
                                        <div class="flex-1">
                                            <div class="text-gray-500 dark:text-gray-400">Terakhir Update</div>
                                            <div class="font-medium text-gray-900 dark:text-white">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center">
                                        <span
                                            class="inline-flex items-center px-3 py-2 rounded-lg text-sm font-medium bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center">
                                        <span
                                            class="inline-flex items-center px-3 py-2 rounded-lg text-sm font-medium bg-indigo-100 dark:bg-indigo-900 text-indigo-800 dark:text-indigo-200">
