                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                        <a href="#"
                            ...
                            <div class="font-semibold text-blue-600 dark:text-blue-400">📄 Kelola Template</div>
                        ...
                        <a href="#"
                            ...
                            <div class="font-semibold text-green-600 dark:text-green-400">👥 Kelola Mahasiswa</div>
                        ...
                        <a href="#"
                            ...
                            <div class="font-semibold text-purple-600 dark:text-purple-400">📊 Laporan</div>
                            <div class="text-sm text-gray-600 dark:text-gray-400 mt-1">Lihat statistik dan laporan
                                aktivitas</div>
                        </a>
                    </div>
                </div>
