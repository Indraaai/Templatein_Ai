        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
                <div class="p-6 sm:p-8">
                    ...
                    <form action="{{ route('admin.faculties.update', $faculty) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name"
                                :value="old('name', $faculty->name)" required autofocus placeholder="Contoh: Fakultas Teknik" />
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="mt-2 text-sm text-yellow-700">
                                        <p>Fakultas ini memiliki <strong>{{ $faculty->program_studies_count ?? 0 }}
                                                program studi</strong>. Perubahan nama akan mempengaruhi semua data
                                            terkait.</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-blue-700">
                            <ul class="list-disc list-inside space-y-1">
                                <li>Dibuat pada: {{ $faculty->created_at->format('d M Y, H:i') }}</li>
                                <li>Terakhir diupdate: {{ $faculty->updated_at->format('d M Y, H:i') }}</li>
                            </ul>
                        </div>
                    </div>
                </div>
