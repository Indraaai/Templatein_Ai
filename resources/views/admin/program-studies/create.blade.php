                ...
                <div class="p-6 sm:p-8">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-sm text-gray-500">
                            Silakan isi form di bawah untuk menambahkan program studi baru.
                        </p>
                    </div>

                    <form action="{{ route('admin.program-studies.store') }}" method="POST" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name"
                                :value="old('name')" required autofocus placeholder="Contoh: Teknik Informatika" />
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-blue-700">
                            <p>Program studi akan ditambahkan ke dalam fakultas yang Anda pilih. Pastikan memilih
                                fakultas yang tepat.</p>
                        </div>
                    </div>
                </div>
            </div>
